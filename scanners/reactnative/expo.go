...
const (
	...
	iosDevelopmentTeamInputSummary = ""
)

const (
	projectRootDirInputTitle   = "Project root directory (the directory of the project app.json/package.json file)"
	projectRootDirInputSummary = ""
)

const (
	expoUserNameInputTitle   = "Expo username"
	expoUserNameInputSummary = ""
)

const (
	expoPasswordInputTitle   = "Expo password"
	expoPasswordInputSummary = ""
)

const (
	isExpoKitInputTitle   = "Project uses Expo Kit (any js file imports expo dependency)?"
	isExpoKitInputSummary = ""
)
