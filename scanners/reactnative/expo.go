...
func (Scanner) expoDefaultOptions() models.OptionNode {
	...
	{
		// ios options
		workspacePathOption := models.NewOption("The iOS workspace path generated ny the 'expo eject' process", ios.ProjectPathInputEnvKey).SetType(models.TypeUserInput)
		expoKitOption.AddOption("yes", workspacePathOption)

		schemeOption := models.NewOption("The iOS scheme name generated by the 'expo eject' process", ios.SchemeInputEnvKey).SetType(models.TypeUserInput)
		...
		// android options
		workDirOption := models.NewOption("Project root directory (the directory of the project app.json/package.json file)", "WORKDIR").SetType(models.TypeUserInput)
		for _, exportMethod := range ios.IosExportMethods {
			exportMethodOption.AddOption(exportMethod, workDirOption)
		}
		...
		// Expo CLI options
		userNameOption := models.NewOption("Expo username", "EXPO_USERNAME").SetType(models.TypeUserInput).SetType(models.TypeUserInput)
		buildVariantOption.AddOption("Release", userNameOption)

		passwordOption := models.NewOption("Expo password", "EXPO_PASSWORD").SetType(models.TypeUserInput).SetType(models.TypeUserInput)
		userNameOption.AddOption("", passwordOption)
	...
	{
		// ios options
		projectPathOption := models.NewOption("The iOS project path generated ny the 'expo eject' process", ios.ProjectPathInputEnvKey).SetType(models.TypeUserInput)
