          ...
          "":
            ...
            value_map:
              ...
              none:
                config: default-macos-config
  react-native:
    title: Was the project created using the Expo CLI?
    summary: If your React Native app was created with the Expo CLI, Bitrise will
      automatically insert the **Expo Eject** Step to your Workflows.
    type: selector
    value_map:
      "no":
        title: The root directory of an Android project
          ...
          "no":
            ...
            value_map:
              ./ios/< PROJECT NAME >.xcworkspace:
                ...
                summary: You can specify the iOS bundle identifier in case the key
                  expo/ios/bundleIdentifier is not set in 'app.json'. Needed as only
                  the Expo bare workflow is supported (https://docs.expo.io/bare/customizing/).
                      ...
                      "":
                        ...
                        value_map:
                          ad-hoc:
                            ...
                            summary: You can specify the Android package name in case
                              the key key expo/android/package is not set in 'app.json'.
                              Needed as only the Expo bare workflow is supported (https://docs.expo.io/bare/customizing/).
                ...
                value_map:
                  "":
                    ...
                    value_map:
                      ./ios/< PROJECT NAME >.xcworkspace:
                        title: iOS bundle identifier
                        summary: You can specify the iOS bundle identifier in case
                          the key expo/ios/bundleIdentifier is not set in 'app.json'.
                          Needed as only the Expo bare workflow is supported (https://docs.expo.io/bare/customizing/).
                        env_key: EXPO_BARE_IOS_BUNLDE_ID
                        type: user_input
                        value_map:
                            ...
                            value_map:
                              "":
                                ...
                                value_map:
                                  ad-hoc:
                                    title: Android package name
                                    summary: You can specify the Android package name
                                      in case the key key expo/android/package is
                                      not set in 'app.json'. Needed as only the Expo
